...
@section('content')
    <p class="ms-4" style="font-size: 25px; font-weight: bold">Add new Student</p>
    <div style=";" class="border ms-4 me-4"></div>
    <div style="width: 90%; height: 500px; margin: auto" class="border border-2 mt-3">
        <form action="{{url('student')}}" style="width: 40%; margin: auto" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3 d-flex justify-content-between align-items-center" style="width: 100%;">
                ...
                <div class="ms-4 mt-4" style="width: 30%;">
                    ...
                    <input type="radio" name="gender" id="gender-fermale" class="" style="" value="1" required>
                    <label for="gender-male" class="form-label">Nữ</label>
                    <input type="radio" name="gender" id="gender-male" class="" style="" value="0" required>
                </div>
            </div>
