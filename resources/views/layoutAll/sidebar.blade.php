                ...
                <div class="container d-flex flex-column justify-content-start align-items-start w-100">
                    <div class="row w-100 navitem">
                        <a class=" d-flex justify-content-start align-items-center ms-4"
                            ...
                            href="{{ url('/teacherclass' . '/' . $user->giaovien_id) }}">
                            <i class="fa-solid fa-house " style="font-size: 30px; flex:2"></i>
                            <p style="font-size: 20px;flex:8 " class=" mt-3 d-sm-none d-md-block">Màn hình chính</p>
                        </a>
                    </div>
                    <div class="row w-100 navitem">
                        <div class=" d-flex justify-content-start align-items-center ms-4">
                            ...
                            <p style="font-size: 20px;flex:8" class=" mt-3 d-sm-none d-md-block">Lịch</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container d-flex  flex-column justify-content-start align-items-start w-100">
                    <div class="row w-100 border-2 border-bottom"
                        ...
                        <div class=" d-flex justify-content-start align-items-center ms-4 ">
                            ...
                            <p style="font-size: 20px;flex:8;" class=" mt-3 d-sm-none d-md-block">Danh sách lớp học</p>
                        </div>
                    </div>
                    @foreach ($classTeach as $item)
                        <div class="row w-100 navitem" style="z-index: 1">
                            <a href="{{ url('class/' . $item->lophoc_id . '/' . ($user->giaovien_id ?: $user->hocsinh_id)) }}"
                                style="color: black; text-decoration: none">
                                <div class="d-flex justify-content-start align-items-center ms-4">
                                    <i class="fa-solid fa-school" style="font-size: 30px;flex:2"></i>
                                    <p style="font-size: 20px;flex:8" class="mt-3 d-sm-none d-md-block">{{ $item->tenlop }}</p>
                                </div>
                            </a>
                        </div>
                    @endforeach
                ...
                <div class="container d-flex flex-column justify-content-start align-items-start w-100">
                    <div class="row w-100 navitem">
                        <div class=" d-flex justify-content-start align-items-center ms-4 ">
                            ...
                            <p style="font-size: 20px;flex:8" class=" mt-3 d-sm-none d-md-block">Lớp học đã lưu trữ</p>
                        </div>
                    </div>
                    <div class="row w-100 navitem">
                        <div class=" d-flex justify-content-start align-items-center ms-4">
                            <i class="fa-solid fa-gear " style="font-size: 30px;flex:2"></i>
                            <p style="font-size: 20px;flex:8" class=" mt-3 d-sm-none d-md-block">Cài đặt</p>
                        </div>
                    </div>
                </div>
            </div>
